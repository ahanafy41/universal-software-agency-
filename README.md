# 🚀 Universal AI Software Engineering Agency
...
## 🛠️ أبرز الميزات والقدرات المحدثة

### 1. 🗺️ الخريطة الذهنية الطوبولوجية للمشروع (`project_mindmap.md`)
...
### 2. 🎯 كود بشري نظيف واحترافي (Human-Grade Clean Code)
...
### 3. 🛡️ قانون السلامة المطلقة وتطويق نطاق التعديل (Zero-Corruption & Blast-Radius Limiter)
...
### 4. 🔍 محرك البحث المباشر والتقصي عبر الإنترنت (Proactive Live Web & SDK Research)
...
### 5. 📋 نظام التتبع المزدوج للتقدم والأعطال (Dual Tracking Artifacts)
...
### 6. 🎯 تحديد مكان الخطأ بدقة متناهية (Exact Location Pinpointing)
...
### 7. 💬 التحقيق والاستكشاف التفاعلي مع المستخدم (Interactive Diagnostic Triage)
* **سؤال واحد مركز في كل رسالة**: عند غموض الخطأ، يلتزم الذكاء الاصطناعي بسؤالك خطوة بخطوة عن الإجراء المسبب، والبيئة، والنتيجة المتوقعة، والسجلات المتاحة.
* **حظر التخمين**: توثيق إجاباتك فوراً في ملفات التتبع قبل اقتراح أي حل.
...
├── README.md                                # الوثيقة التعريفية الشاملة والمحدثة
